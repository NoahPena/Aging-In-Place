...
if ($_GET['id'] == 1)
{
	//exec("sudo python /home/pi/ex1.py");
	$result = exec("sudo python /home/pi/ex1.py", "$output");

}

if ($_GET['id'] == 0)
{
	//exec("sudo python /home/pi/clear.py");

	$result = exec("sudo python /home/pi/clear.py", "$output");
}
session_start();
//////////////////////////////
